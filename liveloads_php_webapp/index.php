...
<h1><?php echo 'LiveLoads App'; ?></h1>
    ...
    <form method="POST" action="edi_process.php">
        <div class="column">
            <label for="ship_notice_identification">Ship Notice Identification:</label>
            <input type="text" id="ship_notice_identification" name="ship_notice_identification"><br><br>
            ...
            <label for="hierarchical_identification">Hierarchical Identification:</label>
            <input type="text" id="hierarchical_identification" name="hierarchical_identification"><br><br>
            ...
            <label for="item_identification">Item Identification:</label>
            <input type="text" id="item_identification" name="item_identification"><br><br>
        ...
        <div class="column">
            <label for="item_detail_identification">Item Detail Identification:</label>
            <input type="text" id="item_detail_identification" name="item_detail_identification"><br><br>
            ...
            <label for="product_description_identification">Product Description Identification:</label>
            <input type="text" id="product_description_identification" name="product_description_identification"><br><br>
            ...
            <label for="name_identification">Name Identification:</label>
            <input type="text" id="name_identification" name="name_identification"><br><br>
            ...
            <label for="transaction_totals_identification">Transaction Totals Identification:</label>
            <input type="text" id="transaction_totals_identification" name="transaction_totals_identification"><br><br>
            ...
            <label for="transaction_set_trailer_identification">Transaction Set Trailer Identification:</label>
            <input type="text" id="transaction_set_trailer_identification" name="transaction_set_trailer_identification"><br><br>
